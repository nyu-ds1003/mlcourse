...
\author{Julia Kempe \& David Rosenberg}
\institute{CDS, NYU}
...
\begin{center}
\includegraphics[height=0.45\textheight]{figures/fig7.4a}\includegraphics[height=0.45\textheight]{figures/fig7.4b}\let\thefootnote\relax\footnotetext{\tiny{KPM Fig. 7.4}}
\par\end{center}
...
\begin{center}
\includegraphics[height=0.45\textheight]{figures/fig7.5a}\includegraphics[height=0.45\textheight]{figures/fig7.5b}\let\thefootnote\relax\footnotetext{\tiny{KPM Fig. 7.5}}
\par\end{center}
...
\end{frame}
%
\begin{frame}{Consequences of our ``Sandwich Proof''}
\begin{itemize}
\item Let $x^{*}$ be primal optimal and $\lambda^{*}$ be dual optimal. 
...
\]
and we have complementary slackness
\end{itemize}
\[
