...
\pause
\item \textbf{Feature templates}: directly design features for each class.
\begin{align}
...
\item \textcolor{blue}{No need to include feature templates unseen in training data}.
\end{itemize}
...
\left\langle w, \p{\Psi(x, \hat{y}) - \Psi(x, {y}}) \right\rangle
